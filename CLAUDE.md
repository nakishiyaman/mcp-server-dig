...
- 現在のステータス: **v0.36.0 開発中**（49ツール: データ取得35 + 組み合わせ分析12 + ワークフロー統合2, Prompts 15, Resources 2, Tool Annotations・MCP Logging・Streamable HTTP・Completions対応、server.registerTool()移行済み、TypeScript 5.9、TransportHandle導入）

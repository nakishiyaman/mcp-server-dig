...
- 現在のステータス: **v0.35.0 開発中**（47ツール: データ取得35 + 組み合わせ分析10 + ワークフロー統合2, Prompts 14, Resources 2, Tool Annotations・MCP Logging・Streamable HTTP・Completions対応、server.registerTool()移行済み、TypeScript 5.9、TransportHandle導入）
